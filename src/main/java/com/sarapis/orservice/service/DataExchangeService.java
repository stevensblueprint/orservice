...
public interface DataExchangeService {
    ...
    PaginationDTO<DataExchangeDTO.Response> getAllDataExchanges(LocalDateTime fromDate, LocalDateTime toDate, Integer page, Integer perPage);
    ...
    int undoImportedFile(String fileImportId, String resourceType, String updatedBy);
}
