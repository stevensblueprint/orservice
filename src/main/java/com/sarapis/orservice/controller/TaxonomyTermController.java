...
public class TaxonomyTermController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<TaxonomyTermDTO.Response> updateTaxonomyTerm(
          @PathVariable String id,
          @Valid @RequestBody TaxonomyTermDTO.Request request,
          @CookieValue(value = "updatedBy", required = false, defaultValue = "SYSTEM") String updatedBy
  ) {
    return ResponseEntity.ok(this.taxonomyTermService.updateTaxonomyTerm(id, request, updatedBy));
  }
